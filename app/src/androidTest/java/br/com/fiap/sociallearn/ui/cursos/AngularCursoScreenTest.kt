...
import br.com.fiap.sociallearn.ui.login.ResetPasswordActivity
...
class AngularCursoScreenTest {

    @get:Rule
    var activityRule: ActivityTestRule<AngularCursoActivity>
            = ActivityTestRule(AngularCursoActivity::class.java)
